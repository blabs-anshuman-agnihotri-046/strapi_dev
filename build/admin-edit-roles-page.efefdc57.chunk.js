(self.webpackChunkcms_survivor=self.webpackChunkcms_survivor||[]).push([[2544],{4644:(H,L,o)=>{"use strict";o.d(L,{V:()=>P});var e=o(82799),E=o(88767);const P=(b={},O={})=>{const{id:A,...x}=b,{get:v}=(0,e.kY)();if(!A&&(O?.enabled===void 0||O?.enabled))throw new Error('"id" is a required argument');const{data:M,error:W,isError:a,isLoading:B,refetch:p}=(0,E.useQuery)(["roles",A,"permissions",x],async()=>{const{data:{data:S}}=await v(`/admin/roles/${A}/permissions`,{params:x});return S},O);return{permissions:M,error:W,isError:a,isLoading:B,refetch:p}}},51754:(H,L,o)=>{"use strict";o.d(L,{F:()=>b});var e=o(82799),E=o(86896),P=o(88767);const b=(O={},A={})=>{const{id:x="",...v}=O,{get:M}=(0,e.kY)(),{locale:W}=(0,E.Z)(),a=(0,e.Xe)(W,{sensitivity:"base"}),{data:B,error:p,isError:S,isLoading:F,refetch:g}=(0,P.useQuery)(["roles",x,v],async()=>{const{data:V}=await M(`/admin/roles/${x??""}`,{params:v});return V},A);let h=[];return x&&B?h=[B.data]:Array.isArray(B?.data)&&(h=B.data),{roles:h.sort((V,oe)=>a.compare(V.name,oe.name)),error:p,isError:S,isLoading:F,refetch:g}}},25545:(H,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>Re,default:()=>Se});var e=o(67294),E=o(40720),P=o(90731),b=o(96987),O=o(12473),A=o(34726),x=o(16607),v=o(10574),M=o(31988),W=o(6498),a=o(38670),B=o(457),p=o(82799),S=o(97695),F=o(66115),g=o(41054),h=o(41609),V=o.n(h),oe=o(86896),de=o(86706),re=o(16550),C=o(71997),pe=o(4644),X=o(36364),G=o(442),_=o(90065),Ce=o(87561);const xe=Ce.Ry().shape({name:Ce.Z_().required(p.I0.required),description:Ce.Z_().required(p.I0.required)}),ae=C.ZP.div`
